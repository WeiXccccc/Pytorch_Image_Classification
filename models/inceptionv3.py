...
def inceptionv3_YXY(pretrained=False, progress=True, num_classes = 2, **kwargs):
    ...
    if pretrained:
        ...
        if not original_aux_logits:
            ...
            del model.AuxLogits
        return model
    # fc_features = InceptionV3.nn.Linear.in_features
    # InceptionV3.fc = nn.nn.Linear(fc_features, num_classes)
    return InceptionV3(num_classes=num_classes)
